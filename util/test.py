import torch
from util.utils import get_val_data, perform_val, buffer_val

if __name__ == "__main__":
    TARGET = "lfw,talfw,agedb_30,calfw,cfp_ff,cfp_fp,cplfw,sllfw"
    ...
    for ver in vers:
        ...
        (
            ...
            writer, name, accuracy, std, xnorm, best_threshold, roc_curve, batch + 1
        )
